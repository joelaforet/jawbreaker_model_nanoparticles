###
# Usage: ./run_OpenMM.sh <Directory_name> ../data/pair_composition.tsv 
...
while IFS='' read -r name; do
  python OpenMM.py -top ${name}.prmtop -crd ${name}.inpcrd -o ${dir}/openmm_${name}_12_4.pdb -i --interval 200 -l 40 --timeit 
done < simfiles
