...
usage: make_box.py [-h] -i INFILE [-s] [-b BUFFER] [-# SEED] -d DIRECTORY_NAME
	optional arguments:
      ...
      -d DIRECTORY_NAME, -- dirname DIRECTORY_NAME
                  Input name of folder to be created that will house all generated files.
'''
...
parser.add_argument('-d', '--dirname', help = "Input name of folder to be created that will house all generated files.", required = True)
